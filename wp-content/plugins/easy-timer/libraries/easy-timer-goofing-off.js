...
var W = Math.floor(S/604800);	//seconds in a week
var D = Math.floor(S/86400);	//seconds in a day
var H = Math.floor(S/3600);		//seconds in an hour
var M = Math.floor(S/60);		//seconds in a minute
var d = D - 7*W;	//days in a week
var h = H - 24*D;	//hours in a day
var m = M - 60*H;	//minutes in a hour
var s = S - 60*M;	//seconds in a minute

var stringW = string0week;
...
if (W == 1) { stringW = string1week; } else if (W > 1) { stringW = stringNweeks.replace('[N]', W); }
...
if (S >= 604800) {
var stringWdhms = stringW+stringd+stringh+stringm+strings;
var stringWdhm = stringW+stringd+stringh+stringm;
var stringWdh = stringW+stringd+stringh;
var stringWd = stringW+stringd;
